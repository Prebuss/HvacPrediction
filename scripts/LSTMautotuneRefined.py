...
# =========================================
# 2) MODEL TRAINING WITH RANDOM SEARCH
# =========================================
...
def main():
    ...
    # Use RandomSearch instead of BayesianOptimization
    tuner = kt.RandomSearch(
        build_model,
        objective='val_loss',
        max_trials=20,
        directory='hvac_tuner_random_dir',
        project_name='lstm_hvac_tuning_random',
        overwrite=True
    )
    ...
    best_model.save("lstm_hvac_forecast_best_random.keras")
    print("✅ Best Random Search optimized model saved as 'lstm_hvac_forecast_best_random.keras'.")
