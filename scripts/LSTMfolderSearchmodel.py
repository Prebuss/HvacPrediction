...
# ✅ Build LSTM Model with Dropout + L2 Regularization
# Feel free to tweak dropout rates or L2 coefficients
model = Sequential([
    LSTM(
        128,
...
# ✅ Compile Model
# You can also experiment with a lower learning rate for the Adam optimizer (e.g., lr=1e-4)
